...
func docResponse(id, content string) map[string]any {
...
func TestDocsRead_PlainText(t *testing.T) {
	...
	svc, cleanup := newReadEditTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		...
		_ = json.NewEncoder(w).Encode(docResponse("doc1", docContent))
	})
	defer cleanup()
...
func TestDocsEdit_UniqueReplacement(t *testing.T) {
	...
	svc, cleanup := newReadEditTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		...
		case r.Method == http.MethodGet:
			_ = json.NewEncoder(w).Encode(docResponse("doc1", "hello foo world"))
...
func TestDocsEdit_NotUnique_Error(t *testing.T) {
	svc, cleanup := newReadEditTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_ = json.NewEncoder(w).Encode(docResponse("doc1", "foo bar foo baz foo"))
	})
	defer cleanup()
	mockDocsService(t, svc)
...
func TestDocsEdit_NotFound_Error(t *testing.T) {
	svc, cleanup := newReadEditTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_ = json.NewEncoder(w).Encode(docResponse("doc1", "hello world"))
	})
	defer cleanup()
	mockDocsService(t, svc)
...
func TestDocsEdit_DryRun_JSON(t *testing.T) {
	svc, cleanup := newReadEditTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		...
		_ = json.NewEncoder(w).Encode(docResponse("doc1", "foo bar foo"))
	})
	defer cleanup()
	mockDocsService(t, svc)
...
func TestDocsEdit_Deletion(t *testing.T) {
	...
	svc, cleanup := newReadEditTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		...
		switch {
		case r.Method == http.MethodGet:
			_ = json.NewEncoder(w).Encode(docResponse("doc1", "hello removeme world"))
		case r.Method == http.MethodPost:
			_ = json.NewDecoder(r.Body).Decode(&gotBatch)
			_ = json.NewEncoder(w).Encode(map[string]any{
				"documentId": "doc1",
...
func TestDocsEdit_NoMatchCase(t *testing.T) {
	...
	svc, cleanup := newReadEditTestServer(t, func(w http.ResponseWriter, r *http.Request) {
		...
		switch {
		case r.Method == http.MethodGet:
			_ = json.NewEncoder(w).Encode(docResponse("doc1", "Hello HELLO hello"))
		case r.Method == http.MethodPost:
			_ = json.NewDecoder(r.Body).Decode(&gotBatch)
			_ = json.NewEncoder(w).Encode(map[string]any{
				"documentId": "doc1",
